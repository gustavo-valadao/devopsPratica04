...
describe('Testes da classe Aluno', () => {
  ...
  test('aprovado deve retornar "aprovad@" para menção MS', () => {
  ...
  test('aprovado deve retornar "aprovad@" para menção SS', () => {
    aluno = new Aluno('Maria', [10, 9]);
    expect(aluno.statusAprovacao()).toBe('aprovad@');
  });
  ...
  test('aprovado deve retornar "aprovad@" para menção MM', () => {
    aluno = new Aluno('Carlos', [5, 6]);
    expect(aluno.statusAprovacao()).toBe('aprovad@');
  });
  ...
  test('aprovado deve retornar "reprovad@" para menção MI', () => {
    aluno = new Aluno('José', [3, 4]);
  ...
  test('deve lançar erro se uma das notas não for número', () => {
    ...
    expect(() => aluno.calcularMedia()).toThrow('Nota inválida!');
  });
